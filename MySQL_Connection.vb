...
Public Class MySQL_Connection
    ...
    Public Overloads Function openConnection(ByVal serverAddress As String, ByVal userName As String, ByVal password As String, ByVal database As String) As Boolean
